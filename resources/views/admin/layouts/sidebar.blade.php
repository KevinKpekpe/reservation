		...
		<div class="wrapper">
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link p-0 pr-3" data-toggle="dropdown" href="#">
							<img src="{{asset('assets/admin/img/avatar.png')}}" class='img-circle elevation-2' width="40" height="40" alt="">
						</a>
			...
			<aside class="main-sidebar sidebar-dark-primary elevation-4">
				...
				<a href="#" class="brand-link">
					...
					<span class="brand-text font-weight-light">Hotel SPECTRE</span>
				</a>
				<!-- Sidebar -->
				<div class="sidebar">
